...
export type ManagerOrderModifierViewModel = {
	id: number;
	name: string;
	quantity: number;
};

export type ManagerOrderLineViewModel = {
	id: number;
	name: string;
	baseDessertName: string | null;
	quantity: number;
	isCombo: boolean;
	modifiers: ManagerOrderModifierViewModel[];
};

export type ManagerOrderViewModel = {
	...
	lines: ManagerOrderLineViewModel[];
};

export type ManagerOrdersViewModel = {
	todayLabel: string;
	totalOrders: number;
	itemsSold: number;
	orders: ManagerOrderViewModel[];
};
...
function buildOrderViewModel(order: SerializedOrderDetails): ManagerOrderViewModel {
